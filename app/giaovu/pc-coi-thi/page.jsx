...
const PcCoiThiTable = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await fetch(`/api/giaovu/pc-coi-thi?namHoc=${namHoc}&kiHoc=${loaiKyThi}`, {
          method: "GET",
  ...
  return (
    <div className="py-2 px-3 shadow-xl bg-white rounded-xl mt-3 h-[85vh] flex flex-col">
      <div className="flex items-center justify-center mb-3">
        <h2 className="font-bold text-heading3-bold flex-grow text-center text-green-500">DANH SÁCH PHÂN CÔNG COI THI</h2>
        <Button
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="w-[25%] flex items-center gap-2">
          ...
          >
            ...
            <Option value="2">Học kỳ 1 (đợt 2)</Option>
            <Option value="2">Học kỳ 1 (đợt 3)</Option>
            <Option value="2">Học kỳ 2</Option>
            <Option value="2">Học kỳ 2 (đợt 2)</Option>
            <Option value="2">Học kỳ 2 (đợt 3)</Option>
            <Option value="2">Kỳ thi phụ (đợt 1)</Option>
            <Option value="2">Kỳ thi phụ (đợt 2)</Option>
            <Option value="2">Kỳ thi phụ (đợt 3)</Option>
            <Option value="1">Học kỳ hè</Option>
          </Select>
        </div>
