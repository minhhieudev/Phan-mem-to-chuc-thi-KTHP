...
import { Button, Input, Form, Space, Typography, InputNumber, Radio, Table, Popconfirm } from "antd";
...
const ExamMonitoringForm = ({ onUpdateCongTacCoiThi,namHoc }) => {
    ...
    return loading ? (
        ...
        <div className="flex gap-5 max-sm:flex-col">
            ...
            <div className="flex-[60%] p-5 shadow-xl bg-white rounded-xl">
